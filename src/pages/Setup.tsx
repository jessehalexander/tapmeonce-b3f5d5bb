      ...
      <main className="flex-1 container max-w-2xl py-8 px-4 pb-28">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {state.step === 2 && <StepAccount state={state} update={update} usernameStatus={usernameStatus} showPassword={showPassword} setShowPassword={setShowPassword} triedNext={triedNext} usernameAutoGenerated={usernameAutoGenerated} />}
...
// Step 2: Account
// ─────────────────────────────────────────────
function StepAccount({ state, update, usernameStatus, showPassword, setShowPassword, triedNext, usernameAutoGenerated }: any) {
  const COUNTRY_CODES = [
